    ...
    with common.RewardTracker(writer, params['stop_reward']) as reward_tracker:
        while True:
            ...
            if frame_idx % params['target_net_sync'] == 0:
                tgt_net.sync()
                best_loss = common.save_model("rainbow_dqn", loss_v.item(), best_loss, net.state_dict())
                common.save_model("rainbow_dqn", loss_v.item(), best_loss, tgt_net.target_model.state_dict())
